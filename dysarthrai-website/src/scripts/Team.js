      ...
      <div>
        ...
        <div className="row">
          <div className="col">
            ...
            <a href="https://www.linkedin.com/in/simon-hodgkinson/" target="_blank" rel="noopener noreferrer">
          ...
          <div className="col">
            ...
            <a href="https://www.linkedin.com/in/michael-powers-0552204b/" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={ faLinkedin } style={{height: 'auto', 'width': '10%', color: '#007bb6'}} className="mx-auto d-block" />
            </a>
          </div>
          <div className="col">
            ...
            <a href="https://www.linkedin.com/in/ungrich/" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={ faLinkedin } style={{height: 'auto', 'width': '10%', color: '#007bb6'}} className="mx-auto d-block" />
            </a>
          </div>
        </div>
