  ...
  render() {
    return (
      <div>
        ...
        <img className="img-fluid" width="50%" height="auto" src={frontend} alt="Front End"/>
        <p>
        ...
        <img className="img-fluid" width="50%" height="auto" src={backend} alt="Back End"/>
        <p>
            The website was created through various services from AWS:
        </p>
        <img className="img-fluid" width="50%" height="auto" src={webArchitecture} alt="Website App Architecture"/>
